...
// Design Name: MouseMasterSM
// Module Name: MouseMasterSM
// Project Name: Mouse
// Target Devices: XILINX FPGA BASYS3
// Tool Versions: Vivado2017.4
// Description: This is the main state machine, responses for the high level host-mouse communication.
//              There are 13 states in this state machine, from state 0 to state 8 are preparartion 
//              for the communication, state 9 transmits the status information and state A and B 
//              transmit the X and Y information respectively.
// 
// Revision:
