...
// Engineer: Yuxin Sun
// 
// Create Date: 2020/01/21 14:35:27
// Design Name: MouseTransceiver
// Module Name: MouseTransceiver
// Project Name: Mouse
// Target Devices: XILINX FPGA BASYS3
// Tool Versions: Vivado2017.4 
// Description: This is the wrapper for mouse-host communcation. There are some instantaites
//              in this model, such as Mouse Transmitter, Mouse State Machine, Mouse Receiver.
//              The inputs are clock reset. And there are two in and out ports, CLK_MOUSE and 
//              DATA_MOUSE. The outputs are mouse coordinats and mouse status.
// 
// Dependencies: 
// 
// Revision:
...
module MouseTransceiver(
    ...
    .probe6(ByteRead)           //input wire [0:0] probe6
    );
