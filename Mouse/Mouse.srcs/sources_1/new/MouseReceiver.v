...
// Engineer: Yuxin Sun 
// 
// Create Date: 2020/01/21 10:13:02
// Design Name: MouseReceiver
// Module Name: MouseReceiver
// Project Name: Mouse
// Target Devices: XILINX FPGA BASYS3
// Tool Versions: Vivado2017.4  
// Description: This model responsible for information transmit from mouse to host.
//              There are 5 states in this model, where state 001 responsbile for
//              data, state 010 responsible for parity check bit, state 011 responsbile
//              for stop bit.
// 
// Revision:
             ...
             */
             ...
             3'b011 : begin
                if(Curr_TimeoutCounter == 100000)
                    ...
                    if (DATA_MOUSE_IN == 1'b0)// Check stop bit error
